...
import { getCookieValue, parseURL, queryString, getRandomNumber, getCurDay } from './url-utils';
import {
  getCurrentHostname,
  normalizeHostname,
 ...
 * // }
 */
export function buildPromptVarsFromJob(
  jobDetail: Record<string, any> | null | undefined
