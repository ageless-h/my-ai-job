...
System.register("./__entry.js", ['./__monkey.entry-CE7ae2Jv.js'], (function (exports, module) {
	'use strict';
	return {
		setters: [null],
		execute: (function () {
...
System.register("./__monkey.entry-CE7ae2Jv.js", ['vue', 'pinia', 'element-plus', 'protobufjs'], (function (exports, module) {
  'use strict';
...
${preset.content}`).join("\n\n");
      ...
      class BossPlatform extends AbsPlatform {
        ...
        async getRenderComponent() {
          if (this.curUrl.includes("www.zhipin.com/web/geek/chat")) {
            const mod = await __vitePreload(() => module.import('./BossMessage-5uM-GiGa-DKsmnoU8.js'), void 0 );
            return mod.default;
          }
...
System.register("./BossMessage-5uM-GiGa-DKsmnoU8.js", ['vue', 'element-plus', './__monkey.entry-CE7ae2Jv.js', 'pinia', 'protobufjs'], (function (exports, module) {
  'use strict';
