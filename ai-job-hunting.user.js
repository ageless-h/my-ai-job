...
System.register("./__entry.js", ['./__monkey.entry-DtzOQIvd.js'], (function (exports, module) {
	'use strict';
	return {
		setters: [null],
		execute: (function () {
...
System.register("./__monkey.entry-DtzOQIvd.js", ['vue', 'pinia', 'element-plus', 'protobufjs'], (function (exports, module) {
  'use strict';
...
${preset.content}`).join("\n\n");
      ...
      class BossPlatform extends AbsPlatform {
        ...
        async getRenderComponent() {
          if (this.curUrl.includes("www.zhipin.com/web/geek/chat")) {
            const mod = await __vitePreload(() => module.import('./BossMessage-DAgKUi0z-Dv8ZOJQ_.js'), void 0 );
            return mod.default;
          }
        ...
        hasNext() {
          ...
          if (this.curUrl.includes("job-recommend")) {
            if ((_d = (_c = userStore$2 == null ? void 0 : userStore$2.user) == null ? void 0 : _c.preference) == null ? void 0 : _d.imE) {
              return true;
            }
        ...
        acquireDataPre() {
          ...
          if (this.curUrl.includes("job-recommend")) {
            if (((_c = (_b = userStore$2 == null ? void 0 : userStore$2.user) == null ? void 0 : _b.preference) == null ? void 0 : _c.imE) && this.getJobList().length === 0) {
          ...
          if (this.curUrl.includes("overseas")) {
            this.lastHeight = ((_d = document.querySelector(".job-list")) == null ? void 0 : _d.scrollHeight) || 0;
            simulateScrollToEnd().then(() => {
              logger$1.info("获取下一页成功");
            }).catch((e) => {
              this.logRecorder.warn("获取下一页失败", e);
...
System.register("./BossMessage-DAgKUi0z-Dv8ZOJQ_.js", ['vue', 'element-plus', './__monkey.entry-DtzOQIvd.js', 'pinia', 'protobufjs'], (function (exports, module) {
  'use strict';
