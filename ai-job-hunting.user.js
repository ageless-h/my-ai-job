...
System.register("./__entry.js", ['./__monkey.entry-BOTyLCet.js'], (function (exports, module) {
	'use strict';
	return {
		setters: [null],
		execute: (function () {
...
System.register("./__monkey.entry-BOTyLCet.js", ['vue', 'pinia', 'element-plus', 'protobufjs'], (function (exports, module) {
  'use strict';
...
请只回复 JSON 格式：{"shouldClean": true/false, "reason": "简短原因"}`;
      ...
      const _withScopeId$3 = (n) => (pushScopeId("data-v-3c844820"), n = n(), popScopeId(), n);
      ...
      const AiJob = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-3c844820"]]);
...
${preset.content}`).join("\n\n");
      ...
      class BossPlatform extends AbsPlatform {
        ...
        async getRenderComponent() {
          if (this.curUrl.includes("www.zhipin.com/web/geek/chat")) {
            const mod = await __vitePreload(() => module.import('./BossMessage-ryaHA52f-c--wd8EH.js'), void 0 );
            return mod.default;
          }
...
System.register("./BossMessage-ryaHA52f-c--wd8EH.js", ['vue', 'element-plus', './__monkey.entry-BOTyLCet.js', 'pinia', 'protobufjs'], (function (exports, module) {
  'use strict';
