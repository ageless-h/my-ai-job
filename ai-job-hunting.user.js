...
System.register("./__entry.js", ['./__monkey.entry-B0PoYypD.js'], (function (exports, module) {
	'use strict';
	return {
		setters: [null],
		execute: (function () {
...
System.register("./__monkey.entry-B0PoYypD.js", ['vue', 'pinia', 'element-plus', 'protobufjs'], (function (exports, module) {
  'use strict';
...
${preset.content}`).join("\n\n");
      ...
      class BossPlatform extends AbsPlatform {
        ...
        async getRenderComponent() {
          if (this.curUrl.includes("www.zhipin.com/web/geek/chat")) {
            const mod = await __vitePreload(() => module.import('./BossMessage-CS6rSr9K-Bpp2xWKq.js'), void 0 );
            return mod.default;
          }
...
System.register("./BossMessage-CS6rSr9K-Bpp2xWKq.js", ['vue', 'element-plus', './__monkey.entry-B0PoYypD.js', 'pinia', 'protobufjs'], (function (exports, module) {
  'use strict';
