...
System.register("./__entry.js", ['./__monkey.entry-DLCqCrwk.js'], (function (exports, module) {
	'use strict';
	return {
		setters: [null],
		execute: (function () {
...
System.register("./__monkey.entry-DLCqCrwk.js", ['vue', 'pinia', 'element-plus', 'protobufjs'], (function (exports, module) {
  'use strict';
  ...
  return {
    ...
    execute: (function () {
      ...
      const UserStore = defineStore("ai-user", () => {
        ...
        const preferenceLoadStatus = ref("idle");
      ...
      async function deleteFriend(securityId) {
        ...
        if (code2 === 0) return { ok: true, message: "", code: code2 };
        return { ok: false, message: ((_b = resp.data) == null ? void 0 : _b.message) || `code=${code2}`, code: code2 };
      }
...
请只回复 JSON 格式：{"shouldClean": true/false, "reason": "简短原因"}`;
      ...
      async function batchDelete(items, onProgress) {
        ...
        const successSecurityIds = [];
        const selected = items.filter((i) => i.selected);
        const isRetryableDeleteError = (msg, status) => {
          if (status === 429 || typeof status === "number" && status >= 500) return true;
          const text = `${msg || ""}`.toLowerCase();
          if (!text) return false;
          if (text.includes("未获取到 zp_token") || text.includes("securityid")) return false;
          return text.includes("network") || text.includes("timeout") || text.includes("频繁") || text.includes("繁忙") || text.includes("稍后") || text.includes("429") || text.includes("status code 5") || text.includes("服务异常");
        };
        const deleteWithRetry = async (securityId) => {
          var _a2;
          const maxRetries = 3;
          let latestMsg = "";
          for (let attempt = 1; attempt <= maxRetries; attempt++) {
            try {
              ...
              latestMsg = (e == null ? void 0 : e.message) || String(e);
              const status = (_a2 = e == null ? void 0 : e.response) == null ? void 0 : _a2.status;
              if (!isRetryableDeleteError(latestMsg, status) || attempt === maxRetries) {
                return { ok: false, message: latestMsg };
              }
            }
            await Tools.sleep(3e3 * attempt);
          }
        ...
        const topFailReason = ((_a = Object.entries(failReasonCounter).sort((a, b) => b[1] - a[1])[0]) == null ? void 0 : _a[0]) || "";
        ...
        setup(__props) {
          ...
          return (_ctx, _cache) => {
            ...
            return openBlock(), createElementBlock("div", _hoisted_1$5, [
              ...
              !candidates.value.length && !scanning.value && scanned.value ? (openBlock(), createElementBlock("div", _hoisted_12$2, " 没有找到需要清理的会话 ")) : createCommentVNode("", true)
            ]);
          };
        }
      });
      ...
      const ConversationCleaner = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-fee02a47"]]);
      const _withScopeId$3 = (n) => (pushScopeId("data-v-3ac1b368"), n = n(), popScopeId(), n);
      ...
      const AiJob = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-3ac1b368"]]);
                  ...
                  default: withCtx2(() => [
                    createElementVNode2("div", null, [
                      ...
                      createElementVNode2("div", _hoisted_10$22, [
                        ...
                        createTextVNode2("         "),
                        createVNode2(_component_el_checkbox, {
                          modelValue: unref$1(userStore).user.preference.imE,
                          "onUpdate:modelValue": ($event) => unref$1(userStore).user.preference.imE = $event,
                          label: "",
                          size: "large"
                        }, {
                          default: withCtx2(() => [
                            createTextVNode2("推荐页无限循环")
                          ]),
                          _: 1
                        }, 8, ["modelValue"])
                      ]),
      ...
      const Preference = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-089b7c3e"]]);
      ...
      const RunRecord = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-8c44b5bf"]]);
...
${preset.content}`).join("\n\n");
      ...
      const _withScopeId = (n) => (pushScopeId("data-v-237138cd"), n = n(), popScopeId(), n);
...
${preset.content}`).join("\n\n");
      ...
      const AiConfig = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-237138cd"]]);
      ...
      class BossPlatform extends AbsPlatform {
        ...
        async getRenderComponent() {
          if (this.curUrl.includes("www.zhipin.com/web/geek/chat")) {
            const mod = await __vitePreload(() => module.import('./BossMessage-CxrMMCwL-0S0Qoe_l.js'), void 0 );
            return mod.default;
          }
...
System.register("./BossMessage-CxrMMCwL-0S0Qoe_l.js", ['vue', 'element-plus', './__monkey.entry-DLCqCrwk.js', 'pinia', 'protobufjs'], (function (exports, module) {
  'use strict';
